window.onload = function () {
    ...
    categorias: [
      {
        ...
        imagen_1152: "img/dom-4477481_1152.jpg",
        imagen_768: "img/dom-4477481_730.jpg",
        imagen_420: "img/dom-4477481_420.jpg",
        imagen_img:"img/dom-4477481_730.jpg",
        alt: "Imagen Catedral",
      ...
      },
      {
        ...
        imagen_1152: "img/light-black-and-white-fog-texture-rain-window-525376-pxhere_1152.jpg",
        imagen_768: "img/light-black-and-white-fog-texture-rain-window-525376-pxhere_768.jpg",
        imagen_420: "img/light-black-and-white-fog-texture-rain-window-525376-pxhere_420.jpg",
        imagen_img: "img/light-black-and-white-fog-texture-rain-window-525376-pxhere_768.jpg",
        alt:"Lluvia y niebla",
    ...
    libros: [
      {
        ...
        imagen_1152: "./img/chess-5516446_1152.jpg",
        imagen_768: "./img/chess-5516446_768.jpg",
        imagen_420: "./img/chess-5516446_420.jpg",
        imagen_img: "./img/chess-5516446_768.jpg",
        alt:"Tablero Ajedrez",
        resumen:
      ...
      },
      {
        ...
        video: "https://www.youtube.com/embed/BoXmoIMhbcc",
      },
      {
        categoria: 0,
        isbn: 9788499088044,
      ...
      },
      {
        ...
        video: "https://www.youtube.com/embed/NC0BD45I1NI",
      },
      {
        categoria: 0,
        isbn: 9788408068983,
      ...
      },
      {
        ...
        resumen_corto:
          "Julia Navarro se consagra con esta electrizante novela en la que el lector viajará hasta los tiempos bíblicos pasando por la Europa de la Segunda Guerra Mundial, Egipto, Siria, Estados Unidos, Italia, Francia, España y el Irak de Sadam.",
        video: "",
      },
      ...
      },
      {
        ...
        imagen_1152: "./img/panama-4948005_1152.jpg",
        imagen_768: "./img/panama-4948005_768.jpg",
        imagen_420: "./img/panama-4948005_420.jpg",
        imagen_img: "./img/panama-4948005_768.jpg",
        alt:"Canal de Panamá",
        resumen:
  ...
  const img_1152 = document.createElement("source");
  img_1152.media = "(min-width: 1200px)";
  img_1152.srcset =categoriaActual[0].imagen_1152;
  img_1152.className="imagen-inicio";
  const img_768 = document.createElement("source");
  img_768.media = "(min-width: 768px)";
  img_768.srcset =categoriaActual[0].imagen_768;
  img_768.className="imagen-inicio";

  const img_420 = document.createElement("source");
  img_420.media = "(min-width: 420px)";
  img_420.srcset = categoriaActual[0].imagen_420;
  img_420.className="imagen-inicio";

  imagenInicio.insertBefore(img_1152,img_no_compatible);
  imagenInicio.insertBefore(img_768,img_no_compatible);
  imagenInicio.insertBefore(img_420,img_no_compatible);

  img_no_compatible.src=categoriaActual[0].imagen_img;
  img_no_compatible.alt=categoriaActual[0].alt;

// Añade uan imagen relacionada con el libro tras detalle del libro. 

const imagenRefLibro = document.getElementById("imagen-ref-libro");
const img_no_compatibleRefLibro=imagenRefLibro.getElementsByTagName("img")[0];  


const img_1152Ref = document.createElement("source");
img_1152Ref.media = "(min-width: 1200px)";
img_1152Ref.srcset =libro[0].imagen_1152;
img_1152Ref.className="imagen-ref-libro";

const img_768Ref = document.createElement("source");
img_768Ref.media = "(min-width: 768px)";
img_768Ref.srcset =libro[0].imagen_768;
img_768Ref.className="imagen-ref-libro";

const img_420Ref = document.createElement("source");
img_420Ref.media = "(min-width: 420px)";
img_420Ref.srcset = libro[0].imagen_420;
img_420Ref.className="imagen-ref-libro";

imagenRefLibro.insertBefore(img_1152Ref,img_no_compatibleRefLibro);
imagenRefLibro.insertBefore(img_768Ref,img_no_compatibleRefLibro);
imagenRefLibro.insertBefore(img_420Ref,img_no_compatibleRefLibro);
